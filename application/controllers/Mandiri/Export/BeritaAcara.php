...
class BeritaAcara extends CI_Controller
{
    ...
    function index()
    {
        $hak_akses = $this->master->read('hak-akses/?ids_level=' . $this->jwt->ids_level . '&ids_modul=66&aksi_hak_akses=export');
        if ($hak_akses->code == 200) {
            ...
            $data = array(
                'title' => 'Export Berita Acara | ' . $_ENV['APPLICATION_NAME'],
                'content' => 'Export/Mandiri/berita_acara/content',
                'css' => 'Export/Mandiri/berita_acara/css',
                'javascript' => 'Export/Mandiri/berita_acara/javascript',
                'modal' => 'Export/Mandiri/berita_acara/modal',
    ...
    function Export()
    {
        ...
        if ($hak_akses->code == 200) {
            ...
            $this->load->view('Export/Mandiri/pdf/berita_acara', $data);
        } else {
            $this->session->set_flashdata('message', 'Hak akses ditolak.');
            $this->session->set_flashdata('type_message', 'danger');
            redirect('dashboard/');
