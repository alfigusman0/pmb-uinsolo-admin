...
class Kelas extends CI_Controller
{
    ...
    function index()
    {
        ...
        if ($hak_akses->code == 200) {
            ...
            $data = array(
                'title' => 'Import Setting Daya Tampung Kelas | ' . $_ENV['APPLICATION_NAME'],
                'content' => 'Import/Setting/kelas/content',
                'css' => 'Import/Setting/kelas/css',
                'javascript' => 'Import/Setting/kelas/javascript',
                'modal' => 'Import/Setting/kelas/modal',
                ...
                for ($row = 2; $row <= $highestRow; $row++) {
                    ...
                    if ($cek->num_rows() > 0) {
                        ...
                        if (!$fb['status']) {
                            ...
                            $error++;
                            $error_message .= "Daya Tampung : Jurusan $jurusan ($kode_jurusan) : $fb->message <br>";
                        }
                    }
                }
