<html lang="en" class="light-style" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url() ?>assets/" data-template="horizontal-menu-template">
...
<head>
  ...
  <!-- Page CSS -->
  <!-- Page -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/css/pages/page-misc.css" />
  <!-- Helpers -->
...
<body>
  ...
  <div class="container-xxl container-p-y">
    <div class="misc-wrapper">
      ...
      <div class="mt-3">
        <img src="<?= base_url() ?>assets/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-light-img="illustrations/page-misc-error-light.png" data-app-dark-img="illustrations/page-misc-error-dark.png" />
      </div>
    </div>
  </div>
  <!-- /Error -->
