<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">Bebas</h4>
    ...
    <div class="row">
        <div class="col-md-6">
            <?= form_open_multipart('kelulusan/import/bebas/import') ?>
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('file/template_kelulusan_mandiri_bebas.xlsx') ?>" class="btn btn-info" target="_blank">Download Template</a>
                </div>
            </div>
        </div>
