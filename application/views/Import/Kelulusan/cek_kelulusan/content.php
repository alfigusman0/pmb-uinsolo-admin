<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">Cek Kelulusan</h4>
    ...
    <div class="row">
        <div class="col-md-6">
            <?= form_open_multipart('kelulusan/import/cek-kelulusan') ?>
            <div class="card">
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <ol>
                        <li>Download template cek kelulusan yang sudah disediakan.</li>
                        <li>Isi kolom pada tabel sesuai nama kolomnya.</li>
                        <li>Pilih file yang ingin di upload.</li>
                        <li>klik import.</li>
                    </ol>
                    <a href="<?= base_url('file/template_cek_kelulusan_mandiri.xlsx') ?>" class="btn btn-info" target="_blank">Download Template</a>
                </div>
            </div>
        </div>
