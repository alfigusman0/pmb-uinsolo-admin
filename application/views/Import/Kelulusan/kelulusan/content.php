<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-6">
            <?= form_open_multipart('kelulusan/import/kelulusan/import') ?>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-primary" type="submit" onclick="return confirm('Apakah anda yakin import kelulusan?')" id="buttonUpload">Upload</button>
                    </div>
                </div>
            </div>
            <?= form_close() ?>
