<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">Export Pilihan</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="<?=base_url('mandiri/export/pilihan/export')?>" target="_blank" id="form" enctype="multipart/form-data">
            <div class="card">
                <div class="card-body">
                    <div class="row">
