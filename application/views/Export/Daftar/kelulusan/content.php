<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="<?=base_url('daftar/export/kelulusan/export')?>" target="_blank" id="form" enctype="multipart/form-data">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <select name="daftar" id="daftar" class="form-select" required>
                                <option value="SEMUA">-- Semua --</option>
