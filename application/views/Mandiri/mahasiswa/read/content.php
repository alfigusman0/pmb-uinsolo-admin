<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header header-elements">
            <span class="me-2 h5">Data Mandiri</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" id="form-filter">
                            ...
                            <div class="form-group row mb-3">
                                <label for="formulir_filter" class="col-sm-2 col-form-label">Status Formulir</label>
                                <div class="col-sm-10">
                                    <select class="form-control" id="formulir_filter">
                                        <option value="">&laquo; Semua &raquo;</option>
