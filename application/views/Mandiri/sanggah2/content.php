                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" id="form-filter">
                            ...
                            <div class="form-group row mb-3">
                                <label for="nama_sekolah_filter" class="col-sm-2 col-form-label">Nama Sekolah</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_sekolah_filter" placeholder="Nama Sekolah">
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                <label for="kelurahan_filter" class="col-sm-2 col-form-label">Kelurahan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="kelurahan_filter" placeholder="Kelurahan">
                                </div>
                            </div>
                            <div class="form-group row mb-3">
