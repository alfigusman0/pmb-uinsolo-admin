...
class SS_kelulusan extends CI_Model
{
	protected $table = 'viewp_kelulusan'; // Nama Tabel
	...
	protected $order = array('YEAR(date_created)' => 'DESC'); // default order
	...
	private function _get_datatables_query()
	{
		...
		$this->_apply_filter('lulus', 'lulus', $post, 'where');
