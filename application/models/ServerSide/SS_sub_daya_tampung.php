...
class SS_sub_daya_tampung extends CI_Model
{
	protected $table = 'views_sub_daya_tampung'; // Nama Tabel
	protected $column_order = array(
		"ids_sub_daya_tampung",
		"date_created",
		"jurusan",
		"fakultas",
		"alias_jalur_masuk",
	...
	private function _get_datatables_query()
	{
		...
		$this->_apply_filter('ids_jalur_masuk', 'ids_jalur_masuk', $post, 'where');
