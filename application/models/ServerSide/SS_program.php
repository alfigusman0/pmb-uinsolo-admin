...
class SS_program extends CI_Model
{
	protected $table = 'tbs_program'; // Nama Tabel
	...
	protected $order = array('kode_program' => 'ASC'); // Default order
	...
	private function _get_datatables_query()
	{
		...
		// Custom filters
		$this->_apply_filter('kode_program', 'kode_program', $post, 'like');
		$this->_apply_filter('program', 'program', $post, 'like');
		$this->_apply_filter('tingkat', 'tingkat', $post, 'like');
		$this->_apply_filter('kelas', 'kelas', $post, 'like');
		$this->_apply_filter('status', 'status', $post, 'like');
