...
class SSh_bobot_nilai_ukt extends CI_Model
{
	protected $table = 'viewh_bobot_nilai_ukt'; // Nama tabel
	...
	protected $order = array('nama_field' => 'ASC', 'tahun' => 'DESC'); // Default order
