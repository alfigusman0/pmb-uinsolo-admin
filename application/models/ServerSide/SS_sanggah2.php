...
class SS_sanggah2 extends CI_Model
{
	protected $table = 'viewp_sanggah'; // Nama Tabel
	...
	protected $order = array('idp_formulir' => 'ASC'); // Default order
	...
	private function _get_datatables_query()
	{
		...
		$this->_apply_filter('nama_sekolah', 'nama_sekolah', $post, 'like');
		$this->_apply_filter('kelurahan', 'kelurahan', $post, 'like');
