...
class SS_bobot_nilai_ukt extends CI_Model
{
	protected $table = 'views_bobot_nilai_ukt'; // Nama Tabel
	...
	protected $order = array('nama_field' => 'ASC'); // default order
	...
	private function _get_datatables_query()
	{
		...
		// Custom filters
		$this->_apply_filter('nama_field', 'nama_field', $post, 'like');
