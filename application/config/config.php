...
$uri = isset($_SERVER['HTTP_X_URI']) ? $_SERVER['HTTP_X_URI'] : '';
$root = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'];
$root .= str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME']);
$config['base_url'] = $root . $uri;
...
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = 'tcp://192.168.31.124:6379?&prefix=pmb:backend:'; // redis => 'tcp://103.55.33.15:6379';
...
*/
$config['proxy_ips'] = ['103.55.33.0/25', '192.168.18.0/24'];
